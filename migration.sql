...
-- AddForeignKey
ALTER TABLE "public"."chemical_reactions" ADD CONSTRAINT "chemical_reactions_sourceLotId_fkey" FOREIGN KEY ("sourceLotId") REFERENCES "public"."pure_metal_lots"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
