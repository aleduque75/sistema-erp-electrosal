...
const processes = [
  ...
  },
  {
    ...
    description: "Revestimentos nobres em ouro, prata e ródio para joias que encantam e resistem ao tempo.",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Equipamentos modernos e processos eco-friendly para resultados excepcionais com responsabilidade.",
    icon: Shield,
              ...
              >
                <div className="relative h-full bg-card border border-border rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-500">
                  ...
                  <div className="relative h-72 overflow-hidden">
                    ...
                    {/* Gradient Overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-t ${process.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
