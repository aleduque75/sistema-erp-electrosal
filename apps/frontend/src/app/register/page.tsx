...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // A verificação de status aqui não é mais necessária,
      // pois o axios entra no catch automaticamente para erros 4xx/5xx.
      ...
      const errorMessage =
        err.response?.data?.message || err.message || "Falha no registro.";
