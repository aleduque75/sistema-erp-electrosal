  ...
  { title: "Tarefas", href: "/protected/dashboard/tasks", icon: ListChecks },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        icon: Package,
        description:
          "Gerencie grupos e configure o método de cálculo de ajuste.",
      },
      {
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        icon: ListChecks,
        description:
          "Consulte a origem e custos de todos os lotes de produtos.",
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        icon: HandCoins,
        description:
          "Consulte o saldo de metal que a empresa deve aos clientes.",
      },
      {
      ...
      },
      {
        ...
        icon: Settings,
        description:
          "Ajuste os saldos iniciais e outras configurações das contas.",
      },
      {
        title: "Transações",
        href: "/transacoes",
      ...
      },
      {
        ...
        description:
          "Converta um pagamento em R$ para um crédito em metal na conta de um cliente.",
      },
      {
        title: "Cotações",
        href: "/quotations",
      ...
      },
      {
        ...
        description:
          "Registre o pagamento a um cliente utilizando metal do estoque.",
      },
      {
        ...
        description:
          "Corrija o valor ou a conta de uma transação de recebimento existente.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        href: "/admin/menu",
        icon: Settings,
        description: "Gerencie a estrutura e ícones do menu lateral.",
      },
      {
        title: "Tutoriais",
