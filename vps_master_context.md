...
🤖 Inteligência e Conciliação (Foco Principal)
    ...
    Lógica: O sistema importa OFX -> O NestJS limpa e envia para o n8n -> O n8n usa o Ollama local para categorizar com base no Plano de Contas do banco -> O sistema atualiza via Prisma.
